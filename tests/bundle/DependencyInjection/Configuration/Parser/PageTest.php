 ...
 * @version //autogentag//
 */
namespace EzSystems\EzPlatformPageFieldTypeBundle\Tests\DependencyInjection\Configuration\Parser;
...
class PageTest extends AbstractParserTestCase
{
    ...
    {
        $extension = new EzPublishCoreExtension(
            [
                new Parser\Page(),
        ...
        $extension->addConfigurationRegistrar(
