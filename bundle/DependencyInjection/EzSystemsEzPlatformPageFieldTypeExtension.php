 ...
 * @version //autogentag//
 */
namespace EzSystems\EzPlatformPageFieldTypeBundle\DependencyInjection;
...
class EzSystemsEzPlatformPageFieldTypeExtension extends Extension implements PrependExtensionInterface
{
    /**
